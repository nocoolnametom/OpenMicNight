...
$test_browser->
  get('/episodeassignment')->

  with('request')->begin()->
    isParameter('module', 'episodeassignment')->
...
$test_browser->
  call('/episodeassignment', 'post', array('content' => json_encode($entity_array)))->
